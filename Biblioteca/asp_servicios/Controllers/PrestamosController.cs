...
namespace asp_servicios.Controllers
{
    ...
    public class PrestamosController : ControllerBase
    {
        ...
        public PrestamosController(IPrestamosAplicacion? iAplicacion /*IAuditoriasAplicacion? iPrestamosAplicacion/*, TokenAplicacion iAplicacionToken*/)
        {
            this.iAplicacion = iAplicacion;
            /* this.iPrestamosAplicacion = iPrestamosAplicacion;*/
