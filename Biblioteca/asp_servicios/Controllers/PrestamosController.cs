...
using lib_repositorios.Implementaciones; // Asegúrate de que esta ruta sea correcta para PrestamosAplicacion
...
namespace asp_servicios.Controllers
{
    ...
    {
        private IPrestamosAplicacion? iAplicacion = null;
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                // Extrae la entidad Prestamos del JSON para usarla como filtro
                var entidad = JsonConversor.ConvertirAObjeto<Prestamos>(
                    JsonConversor.ConvertirAString(datos["Entidad"]));

                this.iAplicacion!.Configurar(Configuracion.ObtenerValor("StringConexion"));

                // Llama al método Buscar. El filtro en Aplicación es por IdLibro o IdMiembro.
