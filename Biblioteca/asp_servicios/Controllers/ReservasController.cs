...
using lib_repositorios.Implementaciones; // Asegúrate de que esta ruta sea correcta para ReservasAplicacion
    ...
    public class ReservasController : ControllerBase
    {
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                // Extrae la entidad Reservas del JSON para usarla como filtro
