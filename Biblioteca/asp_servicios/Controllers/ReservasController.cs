...
namespace asp_servicios.Controllers
{
    ...
    public class ReservasController : ControllerBase
    {
        ...
        private IReservasAplicacion? iReservasAplicacion = null;
        public ReservasController(IReservasAplicacion? iAplicacion /*IAuditoriasAplicacion? iReservasAplicacion/*, TokenAplicacion iAplicacionToken*/)
        {
            this.iAplicacion = iAplicacion;
            /* this.iReservasAplicacion = iReservasAplicacion;*/
