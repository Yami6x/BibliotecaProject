...
namespace asp_servicios.Controllers
{
    ...
    public class ProveedoresController : ControllerBase
    {
        ...
        private IProveedoresAplicacion? iProveedoresAplicacion = null;
        public ProveedoresController(IProveedoresAplicacion? iAplicacion /*IAuditoriasAplicacion? iProveedoresAplicacion/*, TokenAplicacion iAplicacionToken*/)
        {
            this.iAplicacion = iAplicacion;
            /* this.iProveedoresAplicacion = iProveedoresAplicacion;*/
