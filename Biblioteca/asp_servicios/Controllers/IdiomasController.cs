...
namespace asp_servicios.Controllers
{
    ...
    public class IdiomasController : ControllerBase
    {
        ...
        private IIdiomasAplicacion? iIdiomasAplicacion = null;
        public IdiomasController(IIdiomasAplicacion? iAplicacion /*IAuditoriasAplicacion? iIdiomasAplicacion/*, TokenAplicacion iAplicacionToken*/)
        {
            this.iAplicacion = iAplicacion;
            /* this.iIdiomasAplicacion = iIdiomasAplicacion;*/
