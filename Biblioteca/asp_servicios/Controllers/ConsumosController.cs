...
namespace asp_servicios.Controllers
{
    ...
    public class ConsumosController : ControllerBase
    {
        ...
        private IConsumosAplicacion? iConsumosAplicacion = null;
        public ConsumosController(IConsumosAplicacion? iAplicacion /*IAuditoriasAplicacion? iConsumosAplicacion/*, TokenAplicacion iAplicacionToken*/)
        {
            this.iAplicacion = iAplicacion;
            /* this.iConsumosAplicacion = iConsumosAplicacion;*/
