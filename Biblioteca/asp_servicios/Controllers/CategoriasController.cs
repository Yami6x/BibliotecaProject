...
namespace asp_servicios.Controllers
{
    ...
    public class CategoriasController : ControllerBase
    {
        ...
        private ICategoriasAplicacion? iCategoriasAplicacion = null;
        public CategoriasController(ICategoriasAplicacion? iAplicacion /*IAuditoriasAplicacion? iCategoriasAplicacion/*, TokenAplicacion iAplicacionToken*/)
        {
            this.iAplicacion = iAplicacion;
            /* this.iCategoriasAplicacion = iCategoriasAplicacion;*/
