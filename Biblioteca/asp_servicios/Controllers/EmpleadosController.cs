...
namespace asp_servicios.Controllers
{
    ...
    public class EmpleadosController : ControllerBase
    {
        ...
        private IEmpleadosAplicacion? iEmpleadosAplicacion = null;
        public EmpleadosController(IEmpleadosAplicacion? iAplicacion /*IAuditoriasAplicacion? iEmpleadosAplicacion/*, TokenAplicacion iAplicacionToken*/)
        {
            this.iAplicacion = iAplicacion;
            /* this.iEmpleadosAplicacion = iEmpleadosAplicacion;*/
