...
namespace asp_servicios.Controllers
{
    ...
    public class LibrosController : ControllerBase
    {
        ...
        private ILibrosAplicacion? iLibrosAplicacion = null;
        public LibrosController(ILibrosAplicacion? iAplicacion /*IAuditoriasAplicacion? iLibrosAplicacion/*, TokenAplicacion iAplicacionToken*/)
        {
            this.iAplicacion = iAplicacion;
            /* this.iLibrosAplicacion = iLibrosAplicacion;*/
