...
namespace asp_presentacion.Pages.Ventanas
{
    public class PrestamosModel : PageModel
    {
        ...
        public virtual void OnGet()
        {
            ...
            Filtro = new Prestamos { IdLibro = 0 };
            OnPostBtRefrescar();
        }
        ...
        public void OnPostBtRefrescar()
        {
            try
            {
                ...
                var task = this.iPresentacion!.PorIdLibro(Filtro!);
                task.Wait();
                Lista = task.Result;
                Actual = null;
            }
        ...
        public virtual void OnPostBtNuevo()
        {
            try
            {
                ...
                Actual = new Prestamos();
                Actual.FechaPrestamo = DateTime.Now;
                Actual.FechaDevolucion = DateTime.Now;
            }
            catch (Exception ex)
            {
                LogConversor.Log(ex, ViewData!);
